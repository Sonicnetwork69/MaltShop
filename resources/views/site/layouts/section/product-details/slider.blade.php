@php
    ...
    $outStock = false;
@endphp
<div class="w-full xxs:w-72% xxs:transform xxs:translate-x-19% sm:w-1/2 lg:w-36% md:order-none lrt:sm:pr-7 rtl:sm:pl-7">
            ...
            <div class="swiper-wrapper" id="zoomImage">
                @foreach ($images as $ProductImage)
                    ...
                    @php
                        ...
                        @endphp
                        <div class="swiper-slide minimum-height {{ $isVideo ? '' : 'zoom' }} neg-transition-scale w-full" style="background-image: url({{ getBackgroundImage($ProductImage) }});">
                            {!! $src !!}
                        </div>
                @endforeach
            </div>
